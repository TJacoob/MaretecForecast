//$(document).ready(function() {
    ...
    var topPathname = "/forecastNeuModif/";        // CAREFUL: change to suit to your actual installation
	...
	function constructAndAddHtmlLanguageSelectorComponent() {
		...
		//$.getJSON("ajax/languages.json", function(data) {
			...
			console.log(topPathnamePrefix);
			console.log(data.globalJSONDirectory);
